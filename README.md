...
# 📧 Dataset Access
This research utilizes a proprietary dataset of conversations from dating apps. The raw data is not public to protect user privacy.

For Researchers & Supervisors: If you wish to access the anonymized dataset for validation purposes, don't hesitate to get in touch with the author directly.
